...
def feature_extraction(x,fs):
	...
	# Segmentation (number of freqs x number of frames x batch number x 1). The last dimension is 'channel'.
...
def get_model(features_shape):
	...
	input_shape = (features_shape[1],features_shape[2], 1)# (number of freqs x number of frames in a segment)
